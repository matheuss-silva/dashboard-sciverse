...
def lista_orientadores(request):
    ...
    return render(request, 'lista_orientadores/lista_orientadores.html', {'orientadores': orientadores_list})

def people(request):
    queryset = Person.objects.all()
    people_table = PersonTable(queryset)
    return render(request, "lista_orientadores/lista_orientadores.html", {'people_table': people_table})
